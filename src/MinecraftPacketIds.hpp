...
enum class MinecraftPacketIds : int {
    ...
    MovePlayer                             = 19,
    PassengerJump                          = 20, // Deprecated since v800
    UpdateBlock                            = 21,
    AddPainting                            = 22,
    TickSync_Deprecated                    = 23,
    LevelSoundEventV1                      = 24, // Deprecated since v786
    LevelEvent                             = 25,
    BlockEvent                             = 26,
    ActorEvent                             = 27,
    MobEffect                              = 28,
    ...
    BlockActorData                         = 56,
    PlayerInput                            = 57, // Deprecated since v800
    LevelChunk                             = 58,
    ...
    LevelSoundEventV2                      = 120, // Deprecated since v786
    ...
    CompressedBiomeDefinitionList          = 301, // Deprecated since v800
    TrimData                               = 302,
    OpenSign                               = 303,
    AgentAnimation                         = 304,
    ...
    MovementEffect                         = 318,
    SetMovementAuthority                   = 319, // Deprecated since v818
